...
iar.targets.arm.M3.rootDir ?= C:/IAR7/arm
...
.dlls,rm3 .dlls: Clock1.prm3

-include package/cfg/Clock1_prm3.mak
-include package/cfg/Clock1_prm3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Clock1_prm3.dep
endif
Clock1.prm3: package/cfg/Clock1_prm3.xdl
	@


ifeq (,$(wildcard .libraries,rm3))
Clock1.prm3 package/cfg/Clock1_prm3.c: .libraries,rm3
endif

package/cfg/Clock1_prm3.c package/cfg/Clock1_prm3.h package/cfg/Clock1_prm3.xdl: override _PROG_NAME := Clock1.xrm3
package/cfg/Clock1_prm3.c: package/cfg/Clock1_prm3.cfg
package/cfg/Clock1_prm3.xdc.inc: package/cfg/Clock1_prm3.xdl
package/cfg/Clock1_prm3.xdl package/cfg/Clock1_prm3.c: .interfaces

clean:: clean,rm3
	-$(RM) package/cfg/Clock1_prm3.cfg
	-$(RM) package/cfg/Clock1_prm3.dep
	-$(RM) package/cfg/Clock1_prm3.c
	-$(RM) package/cfg/Clock1_prm3.xdc.inc

clean,rm3::
	-$(RM) Clock1.prm3
.executables,rm3 .executables: Clock1.xrm3

Clock1.xrm3: |Clock1.prm3

-include package/cfg/Clock1.xrm3.mak
Clock1.xrm3: package/cfg/Clock1_prm3.orm3 
	$(RM) $@
	@$(MSG) lnkrm3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	LC_ALL=C $(iar.targets.arm.M3.rootDir)/bin/ilinkarm -o C:/Users/yxd/Desktop/Clock1/Debug/Exe/Clock1.out --map C:/Users/yxd/Desktop/Clock1/Debug/List/Clock1.map --log libraries,initialization,redirects,veneers --log_file C:/Users/yxd/Desktop/Clock1/Debug/List/Clock1.log --config C:/Users/yxd/Desktop/Clock1/Clock1_CC1310DK_7XD.icf -f C:/Users/yxd/Desktop/Clock1/configPkg/linker.cmd c:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/cc13xxware_2_04_03_17272/driverlib/bin/iar/driverlib.lib --silent --cpu=Cortex-M3 --entry=__iar_program_start --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall --semihosting --entry __iar_program_start --vfe --silent -o $@ package/cfg/Clock1_prm3.orm3 -f package/cfg/Clock1_prm3.xdl  --semihosting=iar_breakpoint  --cpu=Cortex-M3 --map $(XDCCFGDIR)/$@.map  --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall 
	

Clock1.test test,rm3 test: Clock1.xrm3.test

Clock1.xrm3.test:: Clock1.xrm3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Clock1.xrm3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Clock1.xrm3, ) 
endif

clean,rm3::
	-$(RM) $(wildcard .tmp,Clock1.xrm3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Clock1_prm3.orm3,copy : package/cfg/Clock1_prm3.orm3
Clock1_prm3.srm3,copy : package/cfg/Clock1_prm3.srm3
